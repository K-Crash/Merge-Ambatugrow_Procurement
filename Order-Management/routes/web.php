...
})->middleware(\App\Http\Middleware\BlockOtherModulesIfAuthenticated::class)->name('dashboard');

Route::prefix('goods-receipt-invoice-matching')->middleware(\App\Http\Middleware\BlockOtherModulesIfAuthenticated::class)->group(function () {
    Route::get('/', [MatchingController::class, 'index'])->name('matching.index');
});

Route::prefix('order-management')->middleware(\App\Http\Middleware\BlockOtherModulesIfAuthenticated::class)->group(function () {
...
Route::prefix('supplier-management')->middleware(\App\Http\Middleware\BlockOtherModulesIfAuthenticated::class)->group(function () {
