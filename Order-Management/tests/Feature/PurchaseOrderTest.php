...
class PurchaseOrderTest extends TestCase
{
    ...
    public function test_procurement_dashboard_loads_correctly_publicly()
    {
        // Act
        $response = $this->get('/order-management');
    ...
    public function test_can_send_purchase_order()
    {
        ...
        // Act
        $response = $this->post(route('purchase_orders.send', $po));
    ...
    public function test_can_match_invoice_to_purchase_order()
    {
        ...
        // Act
        $response = $this->post(route('purchase_orders.match_invoice'), [
            'po_number' => 'PO-2026-999',
