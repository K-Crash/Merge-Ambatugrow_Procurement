...
@section('content')
<div x-data="requisitionForm()" x-init="init()">
    ...
    <form id="requisitionForm" method="POST" action="{{ route('requisitions.store') }}" class="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-5"
        ...
        <div class="space-y-5">
            ...
            <div class="card p-5">
                <h2 class="text-sm font-bold text-slate-700 mb-4">Requisition Details</h2>

                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        <label class="block text-xs font-medium text-slate-500 mb-1">Requisition Title</label>
        ...
        <div class="space-y-5">
            <div class="card p-5">
                <h2 class="text-sm font-bold text-slate-700 mb-4">Requisition summary</h2>
        ...
        return {
            ...
            addSelectedServices() {
                this.selectedServices.forEach(service => {
                    // remove a single still-blank first row before adding real items
            ...
            get subtotal() {
                return this.items.reduce((sum, i) => sum + (Number(i.qty) || 0) * (Number(i.unit_price) || 0), 0);
            },
